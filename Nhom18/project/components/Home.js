...
export default class Home extends Component {
         ...
         data: [
            ...
            },
            {
               ...
               image:
                  'https://www.habibi.com.vn/wp-content/uploads/2015/09/cafe-nau-den.jpg',
               about:
                  'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quisenim.Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu.In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo.',
            },
            {
               id: 4,
               name: 'Trà sữa trân châu đường đen',
   ...
   // componentDidMount() {
   //    try {
   //       const response = await fetch('http:/10.0.2.2:8888/WebSV/Select_SanPham.php');
         ...
         <View style={styles.container} >
            ...
            <View style={styles.body}>
               <View style={styles.item}>
                  ...
                  <TouchableOpacity onPress={() => this.props.navigation.navigate('InsertSanPham')}>
                     <View style={styles.iconContent}>
                        <Image
                           style={styles.icon}
